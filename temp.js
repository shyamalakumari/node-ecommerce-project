...
data.forEach(async (e) => {
    const { data: response } = await axios.post("http://localhost:8000/products/create", e,{
        headers: {
            "Authorization": "Bearer U2FsdGVkX1/P29IbkZq0Tuqtu0vwMrF12vzslRfaopMoFHN6f0Zntgb22p4rti4xUZfNjbVSYCOV7JWThJ3LE+sLevhmUdRdvuP2qqRs3r1hmjc2JR7ywnlJ5Y2mXn9MB5BAq4UWs23WDx7/W7/Xig=="
        }
